...
class Pix2PixClassifierModel(BaseModel):
    ...
    def forward(self):
        ...
        self.perceptual_fake_B_out = self.vgg_model.features[:22].forward(self.preprocess_fake_B)
        self.gender_fake_B_out = self.vgg_model.features[:29].forward(self.preprocess_fake_B)
    ...
    def forward_C(self):
        ...
        self.perceptual_real_B_out = self.vgg_model.features[:22].forward(self.preprocess_real_B)
        self.gender_real_B_out = self.vgg_model.features[:29].forward(self.preprocess_real_B)
    ...
    def get_C_errors(self):
        ...
        return OrderedDict([('C_gender', self.loss_C_real.data), ])

    def get_current_errors(self):
        return OrderedDict([('G_GAN', self.loss_G_GAN.data),
                            ('G_L1', self.loss_G_L1.data),
                            ('G_P', self.loss_G_perceptual.data),
                            ('G_C_fake', self.loss_C_fake.data),
